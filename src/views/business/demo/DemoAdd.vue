    ...
    <div class="dialog-container cropper-container">
      <el-dialog title="上传图片" :visible.sync="control.dialogVisible">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" @click="uploadPicture" v-has-permission="'management-information:update'"
                     v-waves>
            {{$t('operate.submit')}}
          </el-button>
      ...
      this.$refs.demo.validate(valid => {
        if (valid) {
          ...
          if (!uploadFileList || uploadFileList.length <= 0) {
            // 新增示例
            insertDemo(this.demo).then(data => {
