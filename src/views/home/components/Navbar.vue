    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        <div class="avatar-wrapper">
          <img
            :src="(user && user.portraitUrl) ? user.portraitUrl : './static/portrait-default.png'"
            class="user-avatar">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <router-link to="/personal-information">
            <el-dropdown-item divided>{{ $t('navbar.personalInformation') }}</el-dropdown-item>
          </router-link>
...
export default {
  ...
  methods: {
    ...
    logout() {
      const _this = this
      MessageBox.confirm('确定退出登录吗？', '退出确认', {
        type: 'warning',
